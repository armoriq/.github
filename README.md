...
**Total downloads (PyPI + npm + GitHub clones):** 32,252

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,699 |
| @armoriq/sdk | npm | Total Downloads | 6,431 |
...
| armoriq-sdk | PyPI | Total Downloads | 20,456 |
