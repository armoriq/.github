...
**Total downloads (PyPI + npm + GitHub clones):** 22,572

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 909 |
| @armoriq/sdk | npm | Total Downloads | 4,275 |
...
| armoriq-sdk | PyPI | Total Downloads | 13,722 |
