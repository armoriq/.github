...
**Total downloads (PyPI + npm + GitHub clones):** 33,550

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,782 |
| @armoriq/sdk | npm | Total Downloads | 6,837 |
| ArmorIQ | Discord Members | Latest Value | 676 |
| ArmorIQ | Discord Messages | Total Messages | 983 |
| armoriq-openclaw-plugin | npm | Total Downloads | 204 |
| armoriq-sdk | PyPI | Total Downloads | 21,265 |
