...
**Total downloads (PyPI + npm + GitHub clones):** 11,022

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 715 |
| @armoriq/sdk | npm | Total Downloads | 1,956 |
...
| armoriq-sdk | PyPI | Total Downloads | 7,967 |
