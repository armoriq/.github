...
**Total downloads (PyPI + npm + GitHub clones):** 33,457

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,775 |
| @armoriq/sdk | npm | Total Downloads | 6,815 |
| ArmorIQ | Discord Members | Latest Value | 675 |
| ArmorIQ | Discord Messages | Total Messages | 962 |
| armoriq-openclaw-plugin | npm | Total Downloads | 204 |
| armoriq-sdk | PyPI | Total Downloads | 21,201 |
