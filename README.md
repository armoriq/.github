...
**Total downloads (PyPI + npm + GitHub clones):** 13,023

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 778 |
| @armoriq/sdk | npm | Total Downloads | 2,394 |
...
| armoriq-sdk | PyPI | Total Downloads | 9,467 |
