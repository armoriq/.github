...
**Total downloads (PyPI + npm + GitHub clones):** 32,597

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,731 |
| @armoriq/sdk | npm | Total Downloads | 6,571 |
...
| armoriq-sdk | PyPI | Total Downloads | 20,629 |
