...
**Total downloads (PyPI + npm + GitHub clones):** 12,406

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 756 |
| @armoriq/sdk | npm | Total Downloads | 2,294 |
...
| armoriq-sdk | PyPI | Total Downloads | 8,972 |
