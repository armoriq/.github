...
**Total downloads (PyPI + npm + GitHub clones):** 29,362

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,143 |
| @armoriq/sdk | npm | Total Downloads | 5,837 |
...
| armoriq-sdk | PyPI | Total Downloads | 18,716 |
