...
**Total downloads (PyPI + npm + GitHub clones):** 33,675

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,794 |
| @armoriq/sdk | npm | Total Downloads | 6,928 |
...
| armoriq-sdk | PyPI | Total Downloads | 21,287 |
