...
**Total downloads (PyPI + npm + GitHub clones):** 31,333

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,620 |
| @armoriq/sdk | npm | Total Downloads | 6,159 |
| ArmorIQ | Discord Members | Latest Value | 644 |
| ArmorIQ | Discord Messages | Total Messages | 733 |
| armoriq-openclaw-plugin | npm | Total Downloads | 204 |
| armoriq-sdk | PyPI | Total Downloads | 19,888 |
