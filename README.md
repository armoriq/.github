...
**Total downloads (PyPI + npm + GitHub clones):** 12,675

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 770 |
| @armoriq/sdk | npm | Total Downloads | 2,354 |
...
| armoriq-sdk | PyPI | Total Downloads | 9,167 |
