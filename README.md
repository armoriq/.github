...
**Total downloads (PyPI + npm + GitHub clones):** 12,785

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 772 |
| @armoriq/sdk | npm | Total Downloads | 2,358 |
...
| armoriq-sdk | PyPI | Total Downloads | 9,271 |
