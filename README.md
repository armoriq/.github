...
**Total downloads (PyPI + npm + GitHub clones):** 24,977

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 938 |
| @armoriq/sdk | npm | Total Downloads | 4,974 |
...
| armoriq-sdk | PyPI | Total Downloads | 15,399 |
