...
**Total downloads (PyPI + npm + GitHub clones):** 33,257

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,774 |
| @armoriq/sdk | npm | Total Downloads | 6,754 |
...
| armoriq-sdk | PyPI | Total Downloads | 21,063 |
