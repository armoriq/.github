...
**Total downloads (PyPI + npm + GitHub clones):** 13,995

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 791 |
| @armoriq/sdk | npm | Total Downloads | 2,437 |
...
| armoriq-sdk | PyPI | Total Downloads | 9,924 |
