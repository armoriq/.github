...
**Total downloads (PyPI + npm + GitHub clones):** 32,874

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,740 |
| @armoriq/sdk | npm | Total Downloads | 6,624 |
...
| armoriq-sdk | PyPI | Total Downloads | 20,844 |
