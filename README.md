...
**Total downloads (PyPI + npm + GitHub clones):** 11,226

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 736 |
| @armoriq/sdk | npm | Total Downloads | 2,004 |
...
| armoriq-sdk | PyPI | Total Downloads | 8,102 |
