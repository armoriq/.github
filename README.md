...
**Total downloads (PyPI + npm + GitHub clones):** 25,197

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 939 |
| @armoriq/sdk | npm | Total Downloads | 5,023 |
...
| armoriq-sdk | PyPI | Total Downloads | 15,569 |
