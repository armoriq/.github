...
**Total downloads (PyPI + npm + GitHub clones):** 19,680

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 877 |
| @armoriq/sdk | npm | Total Downloads | 3,501 |
