...
**Total downloads (PyPI + npm + GitHub clones):** 24,869

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 930 |
| @armoriq/sdk | npm | Total Downloads | 4,930 |
...
| armoriq-sdk | PyPI | Total Downloads | 15,343 |
