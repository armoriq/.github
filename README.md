...
**Total downloads (PyPI + npm + GitHub clones):** 33,163

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,757 |
| @armoriq/sdk | npm | Total Downloads | 6,724 |
...
| armoriq-sdk | PyPI | Total Downloads | 21,016 |
