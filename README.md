...
**Total downloads (PyPI + npm + GitHub clones):** 33,590

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,783 |
| @armoriq/sdk | npm | Total Downloads | 6,855 |
| ArmorIQ | Discord Members | Latest Value | 677 |
| ArmorIQ | Discord Messages | Total Messages | 986 |
| armoriq-openclaw-plugin | npm | Total Downloads | 204 |
| armoriq-sdk | PyPI | Total Downloads | 21,286 |
