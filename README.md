...
**Total downloads (PyPI + npm + GitHub clones):** 16,917

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 860 |
| @armoriq/sdk | npm | Total Downloads | 2,957 |
...
| armoriq-sdk | PyPI | Total Downloads | 10,698 |
