...
**Total downloads (PyPI + npm + GitHub clones):** 21,050

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 896 |
| @armoriq/sdk | npm | Total Downloads | 3,722 |
...
| armoriq-sdk | PyPI | Total Downloads | 12,766 |
