...
**Total downloads (PyPI + npm + GitHub clones):** 32,947

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,741 |
| @armoriq/sdk | npm | Total Downloads | 6,660 |
...
| armoriq-sdk | PyPI | Total Downloads | 20,880 |
