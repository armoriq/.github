...
**Total downloads (PyPI + npm + GitHub clones):** 12,869

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 773 |
| @armoriq/sdk | npm | Total Downloads | 2,364 |
...
| armoriq-sdk | PyPI | Total Downloads | 9,348 |
