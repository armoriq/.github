...
**Total downloads (PyPI + npm + GitHub clones):** 28,527

| Item | Source | Metric | Value |
|------|--------|--------|-------|
| @armoriq/armorclaw | npm | Total Downloads | 1,120 |
| @armoriq/sdk | npm | Total Downloads | 5,782 |
...
| armoriq-sdk | PyPI | Total Downloads | 17,959 |
